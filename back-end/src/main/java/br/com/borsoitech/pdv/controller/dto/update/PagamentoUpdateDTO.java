...
public class PagamentoUpdateDTO implements Serializable {
    ...
    public PagamentoUpdateDTO() { }

    public PagamentoUpdateDTO(Integer parcelas, Double valorPago, Integer tipoPagamento) {
		super();
